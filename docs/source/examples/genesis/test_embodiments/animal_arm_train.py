...
from animal_arm_env import AA2Env
...
def get_cfgs():
    env_cfg = {
        ...
        "kd": 10.0,
        # termination
        "termination_criteria_roll": 35,  # degree
        "termination_criteria_pitch": 35,
    ...
    command_cfg = {
        "num_commands": 11,
        "eef_pos": [[-0.5,0.5],[-0.5,0.5],[0.75,1.5]],
...
parser.add_argument("-e", "--exp_name", type=str, default="animal-walking")
