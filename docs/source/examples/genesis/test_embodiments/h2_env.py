...
class H2Env:
    def __init__(self, num_envs, env_cfg, obs_cfg, reward_cfg, command_cfg, show_viewer=False, device="cuda", add_camera = False):
        ...
        self.robot.set_dofs_kp(list(self.env_cfg["dof_kp"].values()), self.motor_dofs)
        self.robot.set_dofs_kv(list(self.env_cfg["dof_kd"].values()), self.motor_dofs)
        ...
        dof_names_list=env_cfg["dof_names"]
        self.dof_ids = [
