...
class AppolloEnv:
    def __init__(self, num_envs, env_cfg, obs_cfg, reward_cfg, command_cfg, show_viewer=False, device="cuda", add_camera = False):
        ...
        self.robot = self.scene.add_entity(
            gs.morphs.MJCF(
                file="/home/vybhav/Videos/apptronik_appolo/apptronik_apollo.xml",
        ...
        feet_names=["l_ankle_ie_link","r_ankle_ie_link"]
        ...
        knee_names=["l_knee_fe_link","r_knee_fe_link"]
        ...
        hips_names=["r_hip_ie","r_hip_aa","r_hip_fe","l_hip_ie","l_hip_aa","l_hip_fe",]
