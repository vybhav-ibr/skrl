...
def get_cfgs():
    env_cfg = {
        ...
        "default_dof_properties": {
            "left_hip_yaw_joint": [0.0, 200, 5],
            "left_hip_roll_joint": [0.0, 200, 5],
            "left_hip_pitch_joint": [-0.4, 200, 5],
            "left_knee_joint": [0.8, 300, 6],
            "left_ankle_joint": [-0.4, 40, 2],

            "right_hip_yaw_joint": [0.0, 200, 5],
            "right_hip_roll_joint": [0.0, 200, 5],
            "right_hip_pitch_joint": [-0.4, 200, 5],
            "right_knee_joint": [0.8, 300, 6],
            "right_ankle_joint": [-0.4, 40, 2],

            "torso_joint": [0.0, 300, 6],

            "left_shoulder_pitch_joint": [0.0, 100, 2],
            "left_shoulder_roll_joint": [0.0, 100, 2],
            "left_shoulder_yaw_joint": [0.0, 100, 2],
            "left_elbow_joint": [0.0, 100, 2],

            "right_shoulder_pitch_joint": [0.0, 100, 2],
            "right_shoulder_roll_joint": [0.0, 100, 2],
            "right_shoulder_yaw_joint": [0.0, 100, 2],
            "right_elbow_joint": [0.0, 100, 2],
        },
        # termination
