...
class AdamEnv:
    def __init__(self, num_envs, env_cfg, obs_cfg, reward_cfg, command_cfg, show_viewer=False, device="cuda", add_camera = False):
        ...
        self.robot = self.scene.add_entity(
            gs.morphs.MJCF(
                file="/home/vybhav/quadrupeds_locomotion/mujoco_menagerie/pndbotics_adam_lite/adam_lite.xml",
        ...
        feet_names=["anklePitchLeft","anklePitchRight"]
        ...
        knee_names=["thighLeft","thighRight"]
        ...
        hips_names=["hipPitch_Left","hipPitch_Right","hipRoll_Left","hipRoll_Right"]
